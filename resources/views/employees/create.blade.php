    ...
    <div class="space-y-8 p-6">
        ...
        <div class="bg-gradient-to-r from-green-600 to-blue-600 rounded-2xl shadow-xl p-8 text-white">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-4xl font-bold mb-2">Add New Employee</h1>
                    <p class="text-green-100 text-lg">Create a new employee record for the company</p>
                </div>
        ...
        <div class="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
            <div class="p-6 border-b border-gray-200 bg-gradient-to-r from-gray-50 to-gray-100">
                <div class="flex items-center">
                    ...
                    <div>
                        <h3 class="text-xl font-bold text-gray-900">Employee Information</h3>
                        <p class="text-gray-600">Fill in the details below to create a new employee</p>
                    </div>
                </div>
            </div>
